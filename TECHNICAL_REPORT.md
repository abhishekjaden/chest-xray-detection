...
**Three classes show genuine unrealised headroom.** Calcification (12% of a 0.306 ceiling), Other lesion (12% of 0.238), and Pneumothorax (26% of 0.585). Pneumothorax is the clearest case where data volume plausibly *is* the constraint — it has the second-highest agreement in the dataset but only 96 training images.
